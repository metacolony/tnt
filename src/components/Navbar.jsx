...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static" className='!backdrop-blur !bg-white/80 !shadow-xl px-5'>
      <Container maxWidth="xl">
        <Toolbar disableGutters className='!flex !flex-row !justify-start !items-center !gap-20'>
          <Typography
            variant="h6"
            noWrap
            component="a"
